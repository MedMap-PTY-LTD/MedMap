...
import { Award, Users, TrendingUp, Phone, Mail, User, Lock } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ 
        ...
        description: 'Your ambassador application has been submitted for review. We\'ll contact you within 2-3 business days.',
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-6">
          <Link to="/" className="text-3xl font-bold text-purple-600 mb-3 inline-block">
            MedMap
          </Link>
          ...
          <p className="text-sm sm:text-base text-gray-600">
            Join our ambassador program and earn monthly commission
          </p>
        </div>
        ...
        <Card className="w-full shadow-xl border-0">
          <CardHeader className="space-y-1 px-4 sm:px-6">
            <CardTitle className="text-xl sm:text-2xl">Ambassador Application</CardTitle>
            <CardDescription className="text-sm">
              Fill out the form below to apply for the MedMap Ambassador Program. 
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-6 px-4 sm:px-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="motivation" className="text-sm">Why do you want to become a MedMap Ambassador? *</Label>
                  <Textarea 
                    id="motivation"
                    name="motivation"
              ...
              <div className="space-y-3 pt-2">
                <div className="flex items-start space-x-2">
                  ...
                  <Label htmlFor="acceptTerms" className="text-xs sm:text-sm text-gray-600">
                    I agree to the{' '}
                    <Link to="/legal" className="text-purple-600 hover:text-purple-700" target="_blank">
                      Terms of Service
                    </Link>
                    {' '}and{' '}
                    <Link to="/privacy-policy" className="text-purple-600 hover:text-purple-700" target="_blank">
                      Privacy Policy
                    </Link>
                  </Label>
                </div>
                ...
                <div className="flex items-start space-x-2">
                  <Checkbox 
                    id="acceptProgramRules"
                    name="acceptProgramRules"
                    checked={formData.acceptProgramRules}
                    onCheckedChange={(checked) => 
                      setFormData(prev => ({ ...prev, acceptProgramRules: checked as boolean }))
                    }
                    disabled={loading}
                    className="mt-1"
                  />
                  <Label htmlFor="acceptProgramRules" className="text-xs sm:text-sm text-gray-600">
                    ...
                    <Link to="/ambassador-programme" className="text-purple-600 hover:text-purple-700" target="_blank">
                      Ambassador Program Rules & Guidelines
                    </Link>
                  </Label>
                </div>
              </div>
            ...
            <CardFooter className="flex flex-col space-y-3 sm:space-y-4 px-4 sm:px-6 pb-6">
              ...
              <p className="text-xs text-center text-gray-500">
                By submitting this application, you acknowledge that all applications are subject to review and approval by the MedMap team.
              </p>
            </CardFooter>
          </form>
        </Card>
