// pages/patient/PatientSignUp.tsx
  ...
  const signUpMutation = useMutation({
    mutationFn: async (data: SignUpFormData) => {
      ...
      const emergencyContact = {
        ...
        relationship: data.emergencyRelationship || 'Not specified',
      ...
      const conditionsList = data.chronicConditions 
        ? data.chronicConditions.split(',').map(item => item.trim()).filter(item => item)
        : [];

      const medicationsList = data.currentMedications 
        ? data.currentMedications.split(',').map(item => item.trim()).filter(item => item)
        : [];
      ...
      const result = await signUp(data.email, data.password, {
        ...
        medicalAidProvider: data.hasMedicalAid ? data.medicalAidProvider : null,
        medicalAidNumber: data.hasMedicalAid ? data.medicalAidNumber : null,
