    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">MedMap Ambassador Program</h1>
          <p className="text-xl md:text-2xl text-blue-100 mb-2">Grow With Us. Earn As We Grow.</p>
          <p className="text-sm text-blue-200">Confidential | Version 1.0 | 2026</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">What Is the Ambassador Program?</h2>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-xl p-8">
              <p className="text-xl font-semibold text-blue-800 text-center mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-gray-600">Submit your application. All applications are reviewed and approved by the MedMap COO.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-blue-600">2</span>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Get Your Unique Code</h3>
              <p className="text-gray-600">Receive a unique referral code. Doctors using your code are permanently linked to you.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Refer doctors. More active doctors mean higher tier and greater commission.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-blue-600">4</span>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Earn Monthly Commission</h3>
              <p className="text-gray-600">Automatic calculation at month-end. Paid 30 days in arrears.</p>
            </div>
          </div>

          {/* Revenue Flow Example */}
          <div className="max-w-3xl mx-auto bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-8">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">Ambassador Tiers</h2>
          <p className="text-lg text-gray-600 mb-8 text-center">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">Earnings Potential</h2>
          <p className="text-lg text-gray-600 mb-8 text-center">
          ...
          {/* Diamond Scenario */}
          <div className="max-w-3xl mx-auto bg-gradient-to-r from-cyan-50 to-blue-50 border border-cyan-200 rounded-xl p-8">
            <h4 className="text-xl font-semibold text-cyan-800 mb-3 flex items-center">
            ...
            <p className="text-lg font-bold text-cyan-700 mb-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
              ...
              <div className="flex items-center justify-center space-x-2 md:space-x-4 text-blue-800">
                <div className="text-center">
                  <div className="w-14 h-14 md:w-16 md:h-16 bg-blue-200 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="font-bold text-sm md:text-base">Jan</span>
                  </div>
                  <p className="text-xs md:text-sm">Revenue</p>
                </div>
                <span className="text-xl md:text-2xl">→</span>
                <div className="text-center">
                  <div className="w-14 h-14 md:w-16 md:h-16 bg-blue-200 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="font-bold text-sm md:text-base">1 Feb</span>
                  </div>
                  <p className="text-xs md:text-sm">Calculated</p>
                </div>
                <span className="text-xl md:text-2xl">→</span>
                <div className="text-center">
                  <div className="w-14 h-14 md:w-16 md:h-16 bg-green-200 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="font-bold text-sm md:text-base">1 Mar</span>
                  </div>
                  <p className="text-xs md:text-sm">Paid</p>
                </div>
              </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">Ambassador Governance</h2>
          <p className="text-lg text-gray-600 mb-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Monthly Touchpoints</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Quarterly Engagements</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Ambassador Dashboard</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Rules & Safeguards</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Doctor Referral Rules</h3>
              </div>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Fraud & Abuse Prevention</h3>
              </div>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-cyan-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Become a MedMap Ambassador?</h2>
          <p className="text-xl text-blue-100 mb-8">
            Join our growing network and earn monthly commission while helping expand healthcare access across South Africa.
          </p>
          <button className="bg-white text-blue-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-blue-50 transition-colors duration-200 shadow-lg">
            Apply Now
          </button>
        </div>
      </section>
